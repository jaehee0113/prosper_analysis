...
I chose this plot as my final plot because this directly shows the general socioeconomic status of borrowers by looking at where most borrowers live. I live in Sydney and Sydney has similar average income compared to that of California. This was very important factor for my decision to consider the system.
...
Final main determinant is occupation (if employed). Occupation might tell us that for borrowers with some occupations, using this platform not be the good choice. I chose eight occupations because these occupations are my possible occupations in future. Judge has no data. However, for other occupations, in most cases, their loan status is 'completed.' This is another good sign that I can use this platform.
